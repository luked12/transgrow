...
Please find [here](https://drive.google.com/drive/folders/1CqfmbohTKE6kIuSojPHWfgU_yOIVZ2di?usp=sharing) a small, multi-temporal sorted subsets of the [Arabidopsis](https://doi.org/10.5281/zenodo.168158) **'abd'** and the [MixedCrop](https://phenoroam.phenorob.de/geonetwork/srv/eng/catalog.search#/metadata/751c10c4-b6dc-4bcc-bc8c-c0fc5920887a) **'mix'** dataset.
